<template>
	<view class="page">
				...
				<u-form-item label="头像">
					<view class="value" @click="uploadAvatar">
						<u-avatar style="height: 72rpx;" size="72"
							src="http://120.76.202.58/static/user/1.png"></u-avatar>
		...
		<u-picker mode="selector" v-model="showSex" :default-selector="sex" :confirm-color="themeColor" :range="range"
			range-key="label"></u-picker>
		<!-- modal -->
		<u-modal v-model="showUsername" title="修改昵称" show-cancel-button :confirm-color="themeColor">
			<view class="slot-content">
				<u-field label-width="60" focus placeholder="请输入昵称" clearable :border-bottom="false" v-model="username"
					label="昵称" required></u-field>
			</view>
		</u-modal>
		<u-modal v-model="showSignature" title="修改个性签名" show-cancel-button :confirm-color="themeColor">
			<view class="slot-content">
				<u-field label-width="120" focus placeholder="请输入个性签名" clearable :border-bottom="false"
					v-model="signature" label="个性签名" required auto-height type="textarea"></u-field>
			</view>
		</u-modal>
		<u-modal v-model="showPassword" title="修改密码" show-cancel-button :confirm-color="themeColor">
			<view class="slot-content">
				<u-field label-width="120" focus placeholder="请输入密码" clearable v-model="password" label="密码" required
					auto-height></u-field>
				<u-field label-width="120" placeholder="请再次输入密码" clearable :border-bottom="false"
					v-model="passwordAgain" label="确认密码" required auto-height></u-field>
			</view>
		</u-modal>
	</view>
</template>
