<template>
	<view class="page">
		...
		<TitleOperate :title="'商品评价（' + evaluateData.length + '条）'" showMore moreLabel=" " :backgroundColor="bgColor"
			titleSize="32rpx" align="center" @clickMore="$u.route({ url: '/pages-mall/pages/evaluate/list' })">
		</TitleOperate>
		...
		<!-- 精选晒单 -->
		<TitleOperate :title="'精选晒单（' + topicData.length + '条）'" :backgroundColor="bgColor" titleSize="32rpx"
			align="center"></TitleOperate>
		<view class="topci-list">
			...
			<view class="view-more"><u-button size="medium" shape="circle" plain
					@click="$u.route('/pages-community/pages/post/list')">查看全部</u-button></view>
		</view>
		<!-- 相关商品 -->
