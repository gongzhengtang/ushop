<template>
	<view class="page">
		<!-- 带tab的导航栏 -->
		<NvabarTabSearch :tabOps="['圈子', '关注']" placeholder="请输入关键字搜索圈子" :showSearch="showSearch"
			@change="changeNavbarTab" url="/pages-community/pages/community/search"></NvabarTabSearch>
		<!-- 圈子 -->
	...
	export default {
		...
		data() {
			return {
				...
				addOps: [{
						label: '创建圈子',
						icon: 'http://120.76.202.58/static/operate/publish-community.png',
						url: '/pages-community/pages/community/add-or-update?type=add',
						type: 'page'
					},
					{
						label: '发布帖子',
						icon: 'http://120.76.202.58/static/operate/create-community.png',
