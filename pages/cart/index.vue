<template>
	<view class="page">
		<!-- 自定义头部 -->
		<u-navbar :is-back="false" back-icon-name="arrow-leftward" title="购物车"></u-navbar>

		<!-- 购物车列表 -->
		<view class="cart-list">
			<view class="item" v-for="(goods, index) in goodsList" :key="index">
				<view class="left"><u-checkbox shape="circle" active-color="#5758f6" icon-size="16"
						v-model="goods.checked"></u-checkbox></view>
				<view class="right">
					<view class="img">
						<image
							src="https://acbigdata.haier.net/lyyy/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20220419151456.png"
							mode=""></image>
					</view>
					<view class="info">
		...
		<view class="btn">
			<view class="inner">
				<view class="check">
					<u-checkbox shape="circle" active-color="#5758f6" icon-size="16" v-model="checkAllStauts"
		...
		data() {
			return {
				...
				goodsList: [{
					...
					{
						name: 'Healthy Care 辅酶Q10 100粒/瓶*2瓶',
						num: 2,
						sku: '辅酶Q10100粒',
						price: '378',
						checked: false
