		...
		<view class="purchase">
			<view class="pur_left">
				<view class="left_img" @click="goShop()">
					<image src="http://120.76.202.58/static/goods/mall-1.png"></image>
			...
			<view class="pur_right">
				<view class="right_top">
					<view class="top_img" @click="goShop()">
						<image src="http://120.76.202.58/static/goods/mall-3.png" mode=""></image>
				...
				<view class="right_bottom">
					<view class="bottom_img" @click="goShop()">
						<image src="http://120.76.202.58/static/goods/mall-2.png" mode=""></image>
