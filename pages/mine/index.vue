	...
	export default {
		...
		data() {
			return {
				...
				orderNavOps: [{
						name: '待付款',
						img: 'http://120.76.202.58/static/nav/mine-order-2.png',
					...
					{
						name: '待收货',
						img: 'http://120.76.202.58/static/nav/mine-order-3.png',
						url: '/pages-mall/pages/order/list?tabIndex=3'
					},
					{
						name: '退款售后',
						img: 'http://120.76.202.58/static/nav/mine-order-4.png',
				...
				communityNavOps: [{
						name: '我的圈子',
						img: 'http://120.76.202.58/static/nav/mine-community-1.png',
						url: '/pages-mine/pages/community?type=community'
					},
					{
						name: '我的帖子',
						img: 'http://120.76.202.58/static/nav/mine-community-2.png',
						url: '/pages-mine/pages/community?type=post'
					},
					{
						name: '我的关注',
						img: 'http://120.76.202.58/static/nav/mine-community-3.png',
						url: '/pages-mine/pages/community?type=follow'
					},
					{
						name: '我的点赞',
						img: 'http://120.76.202.58/static/nav/mine-community-4.png',
						url: '/pages-mine/pages/community?type=like'
					}
				],
				// 其他导航配置
				otherNavOps: [{
						name: '使用帮助',
						img: 'http://120.76.202.58/static/nav/mine-setting-1.png',
						url: ''
					},
					{
						name: '客服电话',
						img: 'http://120.76.202.58/static/nav/mine-setting-2.png',
						url: ''
					},
					{
						name: '关于我们',
						img: 'http://120.76.202.58/static/nav/mine-setting-3.png',
						url: ''
					},
					{
						name: '地址管理',
						img: 'http://120.76.202.58/static/nav/mine-setting-4.png',
						url: '/pages-mine/pages/address/list'
					},
					{
						name: '我的优惠券',
						img: 'http://120.76.202.58/static/nav/mine-setting-5.png',
						url: '/pages-mine/pages/discounts'
					},
					{
						name: '我的收藏',
						img: 'http://120.76.202.58/static/nav/mine-setting-6.png',
						url: '/pages-mine/pages/collection'
					},
					{
						name: '设置',
						img: 'http://120.76.202.58/static/nav/mine-setting-7.png',
						url: ''
					}
				]
			};
