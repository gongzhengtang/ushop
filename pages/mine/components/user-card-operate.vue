<template>
	<view class="slot" :class="{ border }">
		<view class="left" @click="goUser">
			...
			<view class="sex">
				<u-image width="28rpx" height="28rpx" src="http://120.76.202.58/static/user/sex-0.png"
					v-if="data.sex == '0'"></u-image>
				<u-image width="28rpx" height="28rpx" src="http://120.76.202.58/static/user/sex-1.png"
					v-if="data.sex == '1'"></u-image>
			</view>
		</view>
		<view class="right">
