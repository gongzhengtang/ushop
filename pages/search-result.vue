<template>
	<view class="page">
		<!-- 带搜索框的navbar -->
		<NavbarSearch ref="NavbarSearch" :tabOps="['内容', '商品', '圈子']" v-model="searchKeyWord" @change="tabChange">
		</NavbarSearch>
		<!-- 帖子列表 -->
		...
		<view class="community" v-if="currentTab == '2'">
			<CommunityCard v-for="(item, index) in communityList" :border="communityList.length - 1 != index"
	...
	export default {
		...
		data() {
			return {
				...
				// 圈子列表
				communityList: [{
						pics: 'http://sdyy.apicloud-system.com/images2/imgs/music2.png',
						cateName: '学生党',
						desc: '一起来学习呀'
					},
					{
						pics: 'http://sdyy.apicloud-system.com/images2/imgs/music1.png',
						cateName: '好听的音乐',
						desc: '这首歌的等你来听这首歌的等你…'
					},
					{
						pics: 'http://sdyy.apicloud-system.com/images2/imgs/music3.png',
						cateName: '音悦台',
						desc: '这首歌的等你来听…'
					}
				],
